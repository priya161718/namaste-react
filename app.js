    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className="logo"src="https://graphiccloud.net/wp-content/uploads/2021/07/High-Quality-Burger-Logo.png" />
            </div>
...
//not using keys (not acceptable)<<index as a key <<<<unique id (bestpractice)
const Body =() =>{
    return(
        <div className="body">
